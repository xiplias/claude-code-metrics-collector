...
// Initialize test SQLite database (in-memory)
...
export const testUpsertSession = testDb.prepare(`
...
export const testUpdateSessionCost = testDb.prepare(`
  UPDATE sessions 
...
export const testInsertMessage = testDb.prepare(`
...
export const testUpdateMessageTokens = testDb.prepare(`
  UPDATE messages 
